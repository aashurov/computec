    ...
    margin-top:100px;
      ...
      <body>  
        <div class="container box">
          ...
          <?php
          $connect = mysqli_connect("localhost", "root", "root", "computec"); //Connect PHP to MySQL Database
          $query = '';
          $table_data = '';
          ...
          foreach($array as $row) //Extract the Array Values by using Foreach Loop
          {
           ...
           $query .= "INSERT INTO tbl_employee(name, gender, designation) VALUES ('".$row["name"]."', '".$row["gender"]."', '".$row["designation"]."'); "; 
           $table_data .= '
            <tr>
       <td>'.$row["name"].'</td>
       <td>'.$row["gender"].'</td>
